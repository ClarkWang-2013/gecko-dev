...
class MacroAssemblerMIPS64 : public Assembler
{
  public:
    ...
    void movq(Register rd, Register rs);
  ...
  public:
    ...
    void ma_cmp_set(Register dst, Address lhs, ImmPtr imm, Condition c) {
        ...
        ma_li(SecondScratchReg, ImmWord(uintptr_t(imm.value)));
...
class MacroAssemblerMIPS64Compat : public MacroAssemblerMIPS64
{
  ...
  public:
    ...
    void retn(Imm32 n) {
        // pc <- [sp]; sp += n
        ma_ld(ra, Address(StackPointer, 0));
...
public:
  ...
  public:
    ...
    void Pop(Register reg) {
        ma_pop(reg);
        adjustFrame((int)-sizeof(intptr_t));
    }
